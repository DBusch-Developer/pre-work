    ...
    sections: [
      {
        ...
        description:
          "Asked AI things I genuinely wanted to know — no code, just curiosity.",
        qa: [
          {
            q: "Why does music give people chills?",
            a: `That "chills" feeling from music — often called frisson — is a mix of brain chemistry, prediction, and emotion all firing at once.
...
The chills themselves — goosebumps — are part of an old fight-or-flight response. Your body reacts as if something intense or meaningful is happening, even though it's "just" music.`,
          },
          {
            q: "Explain compound interest like I'm 15",
            a: `Compound interest = earning interest on your interest.
...
Compound interest works both ways:
  ...
  • 👎 Debt (like credit cards) → it grows against you just as fast`,
          },
          {
            q: "What happens to your body when you don't sleep?",
            a: `Sleep isn't just "rest" — it's when your body does maintenance. Skip it, and things start breaking down fast.
...
Eventually, something crashes.`,
          },
          {
            ...
            a: `📉 Recession vs. Depression (simple version)
...
Both are bad — but one is on a completely different level.`,
          },
          {
            q: "Why do we dream?",
            a: `Dreaming is one of those things where science has strong theories — but no single final answer. What researchers agree on is that dreams aren't random noise; they seem to serve a few important purposes.
        ...
        qa: [
          {
            ...
            a: `I don't have any record of what you ate last night — and I'm definitely not secretly watching your dinner 😄
...
If you tell me what you think it might've been, I can help you piece it together.`,
          },
          {
            q: "Count every letter in 'onomatopoeia'",
            a: `onomatopoeia has 12 letters.`,
          },
          {
            q: "What's happening right now on my street?",
            a: `I don't have access to live cameras or real-time info about your exact street, so I can't see what's happening there right now.
...
If you tell me what you're noticing (noise, lights, etc.), I can help you guess what might be going on.`,
          },
        ],
      },
      {
